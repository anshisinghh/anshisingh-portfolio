  ...
  return (
    <section className="relative flex flex-row items-center z-20 mx-auto md:gap-[37px] md:mx-10">
        <div className="flex flex-col gap-[13px] items-center md:gap-[34px] md:my-[58px] md:mr-[35px] md:items-start">
            ...
            <p className="text-center text-sm mx-6 md:text-[22px] md:text-start md:mx-0">Here is my bio. I am a 4th year at UC San Diego, I will be graduating with a degree in Computer Science.</p>
            <a href="mailto:anshisingh730@gmail.com" className="self-center bg-primary text-white p-2.5 rounded flex gap-2.5 items-center text-sm md:self-start md:text-xl/6">Let's Connect <img src="/arrow_right_icon.svg" alt="Arrow right icon"></img></a>
        </div>
        <div>
            ...
            <Image src="/profile_picture.jpg" alt="Anshi Singh profile picture" width={313} height={417} className="hidden md:block min-w-[313px] h-[417px] z-10 mr-[7.7px] my-[6.5px]"></Image>
        </div>
    </section>
  )
}
