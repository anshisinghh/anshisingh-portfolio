...
const Project = ({ thumbnail, title, link, description, languageIcons }: Props) => {
  ...
  return (
    <Reveal initialX={-50} delay={0.5}>
      <motion.div onMouseMove={handleMouseMove} onMouseOut={handleMouseLeave} className="card flex flex-col items-stretch w-full max-w-[428.4px] p-5 md:p-[18px] gap-[30px]" style={{transformStyle: "preserve-3d", rotateX: xRotation, rotateY: yRotation}}>
