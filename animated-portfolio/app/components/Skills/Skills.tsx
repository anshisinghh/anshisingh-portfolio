...
const Skills = () => {
  return (
    <SectionContainer id="skills">
        ...
        {/* <Image src="/tech_stack_grid_dark.svg" alt="Background grid decoration" width={569} height={373} className="hidden md:block -z-10 absolute -left-[135px] -top-[39px]"></Image> */}
    </SectionContainer>
  );
};
